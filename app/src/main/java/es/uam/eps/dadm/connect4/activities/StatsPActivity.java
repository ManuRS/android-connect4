 ...
 */
public class StatsPActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_statsp);

        FragmentManager fm = getFragmentManager();

        if (fm.findFragmentById(R.id.fragmentPStats) == null) {
            Fragment fr = new StatsPFragment();
            fm.beginTransaction().add(R.id.fragmentPStats, fr).commit();
        }
